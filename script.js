...
while (localStorage.getItem("room") === "null" || localStorage.getItem("room") === "" ){
    localStorage.setItem("room", prompt("Введите номер кабинета"))
}
...
function startTimer(timeStart) {
    ...
    const requestURL = `/start_olympiad?room=${localStorage.getItem("room")}&duration=${timeStart}`;
